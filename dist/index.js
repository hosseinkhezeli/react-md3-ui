...
function useButtonA11y({ children, loading, disabled, ariaLabel, onKeyDown, }) {
    const loadingId = require$$0.useId();
...
function useButtonGroupA11y({ count, type, selectedIndices, onSelect, ariaLabel, ariaLabelledBy, }) {
    const refs = require$$0.useRef(Array(count).fill(null));
...
function ButtonGroup({ children, count = require$$0.Children.count(children), type = 'standard', selectedIndices = [], onSelect, ariaLabel, ariaLabelledBy, size = 'md', variant = 'outlined', shape = 'round', }) {
    ...
    return (jsxRuntimeExports.jsx("div", { className: 'md3-btn-group', "data-type": type, "data-size": size, "data-variant": variant, "data-shape": shape, ...getGroupProps(), children: require$$0.Children.map(children, (child, idx) => {
...
const ThemeProvider = ({ children }) => {
    const [theme, setTheme] = require$$0.useState('light');
